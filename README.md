[![Build Status](https://dev.azure.com/guimabdo/WebTyped/_apis/build/status/guimabdo.webtyped?branchName=master)](https://dev.azure.com/guimabdo/WebTyped/_build/latest?definitionId=4&branchName=master)
